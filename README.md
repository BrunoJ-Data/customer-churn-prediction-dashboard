...
'Readme'mis à jour prochainement....

## ⚙️ Data Preparation & Wrangling
- **Data Pipeline:** Nettoyage, structuration et agrégation de jeux de données complexes (features ingénierie, gestion des valeurs manquantes, encodage).
